...
<head>
  ...
  <title>register - Admin One Tailwind CSS Admin Dashboard</title>
        ...
        <form method="POST" action="{{ route('adminRegister') }}" enctype="multipart/form-data">
          ...
          <div class="field spaced">
            ...
            <div class="control icons-left">
              <input class="input @error('name') is-danger @enderror" type="text" id="username" name="name" value="" placeholder="name" autocomplete="username">
